...
def cargar_documentos_elastic():
    ...
    try:
        ...
        if metodo == 'zip':
            ...
            # pln = PLN(cargar_modelos=True)  # Descomentar cuando tengas el módulo PLN
            ...
            for archivo in archivos:
                ...
                # Procesar con PLN (comentado temporalmente)
                try:
            ...
            # pln.close()  # Descomentar cuando tengas el módulo PLN
